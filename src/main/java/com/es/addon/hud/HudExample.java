package com.es.addon.hud;

import com.es.addon.EsAddon;
...
public class HudExample extends HudElement {
     ...
     */
    public static final HudElementInfo<HudExample> INFO = new HudElementInfo<>(EsAddon.HUD_GROUP, "example", "HUD element example.", HudExample::new);
